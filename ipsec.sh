...
wget -O /usr/bin/lp https://raw.githubusercontent.com/syndrexhub/im/main/add-l2tp.sh && chmod +x /usr/bin/lp
wget -O /usr/bin/lpd https://raw.githubusercontent.com/syndrexhub/im/main/del-l2tp.sh && chmod +x /usr/bin/lpd
wget -O /usr/bin/pp https://raw.githubusercontent.com/syndrexhub/im/main/add-pptp.sh && chmod +x /usr/bin/pp
wget -O /usr/bin/ppd https://raw.githubusercontent.com/syndrexhub/im/main/del-pptp.sh && chmod +x /usr/bin/ppd
wget -O /usr/bin/ppr https://raw.githubusercontent.com/syndrexhub/im/main/renew-pptp.sh && chmod +x /usr/bin/ppr
wget -O /usr/bin/lpr https://raw.githubusercontent.com/syndrexhub/im/main/renew-l2tp.sh && chmod +x /usr/bin/lpr
