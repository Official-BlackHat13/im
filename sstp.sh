...
state=Thailand
locality=Thailand
organization=www.myserver.aj-net.com
organizationalunit=www.myserver.aj-net.com
commonname=jAvaNet
...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/syndrexhub/im/main/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/sp https://raw.githubusercontent.com/syndrexhub/im/main/add-sstp.sh && chmod +x /usr/bin/sp
wget -O /usr/bin/spd https://raw.githubusercontent.com/syndrexhub/im/main/del-sstp.sh && chmod +x /usr/bin/spd
wget -O /usr/bin/spc https://raw.githubusercontent.com/syndrexhub/im/main/cek-sstp.sh && chmod +x /usr/bin/spc
wget -O /usr/bin/spr https://raw.githubusercontent.com/syndrexhub/im/main/renew-sstp.sh && chmod +x /usr/bin/spr
rm -f /root/sstp.sh
