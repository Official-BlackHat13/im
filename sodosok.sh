#!/bin/bash
#shadowsocks-libev obfs install by izZuVpn
...
cd /usr/bin
wget -O ss "https://github.com/syndrexhub/im/raw/main/add-ss.sh"
wget -O sd "https://github.com/syndrexhub/im/raw/main/del-ss.sh"
wget -O sc "https://github.com/syndrexhub/im/raw/main/cek-ss.sh"
wget -O sr "https://github.com/syndrexhub/im/raw/main/renew-ss.sh"
chmod +x ss
chmod +x sd
chmod +x sc
chmod +x sr
