...
if [[ -e /etc/wireguard/params ]]; then
	echo -e "${Info} Install successfull, plese type "wg" for adding a new account."
	exit 1
fi
...
# Tambahan
cd /usr/bin
wget -O wg "https://raw.githubusercontent.com/syndrexhub/im/main/add-wg.sh"
wget -O wgd "https://raw.githubusercontent.com/syndrexhub/im/main/del-wg.sh"
wget -O wgc "https://raw.githubusercontent.com/syndrexhub/im/main/cek-wg.sh"
wget -O wgr "https://raw.githubusercontent.com/syndrexhub/im/main/renew-wg.sh"
chmod +x wg
chmod +x wgd
chmod +x wgc
chmod +x wgr
